...
class GrowthScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final completion = const BalanceScoringEngine().completionRatio(state.actions);
          ...
          child: ScreenScroll(
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(child: Text('Growth Phase', style: Theme.of(context).textTheme.displayLarge?.copyWith(fontSize: 44))),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text('${(completion * 100).round()}%', style: Theme.of(context).textTheme.headlineMedium),
                      Text('COMPLETED', style: Theme.of(context).textTheme.labelSmall),
                    ],
                  ),
                ],
              ),
              ...
              TonalCard(
                child: Row(
                  children: [
                    const Icon(Icons.checklist_rounded, color: MindfulColors.clayAccent),
                    const SizedBox(width: 12),
                    Expanded(child: Text('Actionable Steps', style: Theme.of(context).textTheme.titleMedium)),
                    Text('$pendingCount', style: Theme.of(context).textTheme.headlineMedium),
              ...
              ...state.actions.map(
                (item) => Padding(
                  ...
                  child: TonalCard(
                    ...
                    color: item.completed ? MindfulColors.surfaceContainerHigh : MindfulColors.surfaceContainerLowest,
                    child: Row(
                      children: [
                        Checkbox(
                        ...
                        const Icon(Icons.drag_indicator_rounded, color: MindfulColors.onSurfaceVariant),
                      ],
                    ),
                  ),
                ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Generate Full Report', style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white)),
              ...
              Center(
                child: Text('Stay in the flow.', style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: MindfulColors.onSurfaceVariant)),
              ),
            ],
          ),
        ),
